...
local UserName = (data.username_ or "DEV-NAG")
...
if userid == tonumber(1366055467) then
send(msg.chat_id_, msg.id_, "• لا يمكن { حظر،كتم،طرد،تقيد،الخ ..} مبرمج السورس \n")
return false 
end
...
send(msg.chat_id_, msg.id_,"• العضو > ["..data.first_name_.."](t.me/"..(data.username_ or "DEV-NAG")..")".."\n• تم رفعه "..RTPA.." هنا\n")
...
if NiggArt == "مميز" and Addictive(msg) then
send(msg.chat_id_, msg.id_,"• العضو > ["..result.title_.."](t.me/"..(text1[3] or "DEV-NAG")..")".."\n• تم رفعه "..text1[2].." هنا")   
database:sadd(bot_id.."Special:User"..msg.chat_id_,result.id_)  
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n•> العضو > ['..data.first_name_..'](t.me/'..(data.username_ or 'DEV-NAG')..') ~'
...
usertext = '\n• العضو > ['..result.title_..'](t.me/'..(username or 'DEV-NAG')..')'
status  = '\n• تم تقيده لمدة  { '..TextEnd[2]..' '..TextEnd[3]..'}'
...
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'DEV-NAG')..')'
...
local UserName = (b.username_ or "DEV-NAG")
...
لعبة رياضيات >> رياضيات
 ...
 لعبة بات >> بات
•━━━━━━• 
- Ch [𝘕𝘐𝘎𝘎𝘈 - SoUrCe](https://t.me/DEV-NAG)
]]
...
os.execute('wget https://raw.githubusercontent.com/Bandaa2/Bandaa2/main/NiggA.lua')
os.execute('wget https://raw.githubusercontent.com/Bandaa2/Bandaa2/main/start.lua')
dofile('NiggA.lua')  
return false
end
if text == "راسلني" then
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '▽𝐬𝐨𝐨𝐧 𝐩𝐥𝐮𝐬▽',url="t.me/DEV-NAG"}},
}
local msg_id = msg.id_/2097152/0.5
...
if DevNiggA(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/Bandaa2/files_NiggA/main/getfile.json")
if res == 200 then
...
Text = "[𝘞𝘦𝘭𝘤𝘰𝘮𝘦 𝘵𝘰 𝘕𝘪𝘨𝘨𝘢 𝘚𝘰𝘶𝘳𝘤𝘦](t.me/DEV-NAG)"
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝘕𝘪𝘨𝘨𝘢 𝘚𝘰𝘶𝘳𝘤𝘦 .',url="https://t.me/s_o_op"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
return false
...
if text == '@U880p' or text == '@DEV-NAG' or text == 'مودي البدراني' then
Text = [[
@U880p هذا مطور سورس نيغا
]]
send(msg.chat_id_, msg.id_,Text)
return false
end
...
inline = {
{{text = '▽𝐬𝐨𝐨𝐧 𝐩𝐥𝐮𝐬▽',url='http://t.me/s_o_op'}},
}

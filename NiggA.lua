...
send(msg.chat_id_, msg.id_, "• لا يمكن { حظر،كتم،طرد،تقيد،الخ ..} المبرمج باندا \n")
return false 
end
...
send(msg.chat_id_, msg.id_,"• العضو > ["..data.first_name_.."](t.me/"..(data.username_ or "s_o_op")..")".."\n• تم رفعه "..RTPA.." هنا\n")
...
if NiggArt == "مميز" and Addictive(msg) then
send(msg.chat_id_, msg.id_,"• العضو > ["..result.title_.."](t.me/"..(text1[3] or "s_o_op")..")".."\n• تم رفعه "..text1[2].." هنا")   
database:sadd(bot_id.."Special:User"..msg.chat_id_,result.id_)  
...
لعبة رياضيات >> رياضيات
 ...
 لعبة بات >> بات
•━━━━━━• 
- Ch [𝘕𝘐𝘎𝘎𝘈 - SoUrCe](https://t.me/s_o_op)
]]
...
os.execute('wget https://raw.githubusercontent.com/Bandaa2/DEV-NAG/main/NiggA.lua')
os.execute('wget https://raw.githubusercontent.com/Bandaa2/DEV-NAG/main/start.lua')
dofile('NiggA.lua')  
return false
end
if text == "راسلني" then
...
local json_file, res = https.request("https://raw.githubusercontent.com/Bandaa2/files_NiggA/main/files_NiggA/"..file)
if res == 200 then
...
if text == 'اريد انصب بوت' or text == 'عجبني البوت' or text == 'منو منصبلك' or text == 'منو المبرمج باندا' or text == 'المبرمج باندا' or text == 'انصبلك'  or text == 'انصبلك بوت' then
Text = [[
اهلا عزيزي
...
if text == '@ZZZZD' or text == '@s_o_op' or text == 'مودي البدراني' then
Text = [[
...
inline = {
{{text = '•  𝘕𝘐𝘎𝘎𝘈  .',url='http://t.me/s_o_op'}},
}
